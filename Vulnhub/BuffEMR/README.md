...
En caso de no haber realizado la máquina BuffEMR, es recomendable revisar el [writeup](http://mrpr1ngl3s.github.io/writeups/vulnhub/buffemr/ ) para comprender el autopwn.
