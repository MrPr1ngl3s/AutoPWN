...
En caso de no haber realizado la máquina DarkHole1, es recomendable revisar el [writeup](http://mrpr1ngl3s.github.io/writeups/vulnhub/darkhole1/ ) para comprender el autopwn.
