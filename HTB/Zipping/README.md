...
En caso de no haber realizado la máquina Zipping, es recomendable revisar el [writeup](https://mrpr1ngl3s.github.io/writeups/htb/Zipping) para comprender el autopwn.
