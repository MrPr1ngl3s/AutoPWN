...
En caso de no haber realizado la máquina Zipping, es recomendable revisar el [writeup](https://mrpr1ingl3s.github.io/htb/zipping) para comprender el autopwn.
