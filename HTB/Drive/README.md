...
En caso de no haber realizado la máquina Drive, es recomendable revisar el [writeup](https://mrpr1ngl3s.github.io/writeups/htb/Drive) para comprender el autopwn.
